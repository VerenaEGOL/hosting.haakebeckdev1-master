...
if ($submit && !$eintrag) {
    ...
    if (empty($error)) {
        $stmt = $pdo->prepare('INSERT INTO `2017_12_Weihnachten` (`antw`, `anrede`, `v_name`, `n_name`, `strasse`, `plz`, `ort`, `email`, `telefon`, `geburtstag`, `eintrag`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
...
?>
    ...
    <body class="maintheme">
        ...
        <div class="grid margtop">
            ...
            Weihnachtsgewinnspiel </h1>
                                ...
                                <form action="/aktionen/weihnachtsgewinnspiel/" method="post" accept-charset="uft-8">
        ...
        <a class="regular" href="http://sixdaysbremen.de/" target="_blank">Alle Infos zu den SIXDAYS</a>  </p>
                                    <?php if ($eintrag == 1) {
    ?>
                                    <br />
    ...
    ?>
        ...
        ?>
                                    ...
                                    <h2 class="yellow">Zum wievielten Mal finden die SIXDAYS BREMEN statt?</h2>
                                    ...
                                    <label class="floatleft">54</label>
                                    <div class="clear"></div>
                                    ...
                                    <div class="twoculumform">
                                        ...
                                        <p>
                                            <br>
                                            <input type="checkbox" name="tnb" class="margintop" value="1" /> Ich habe die Teilnahmebedingungen und die <a href="/datenschutz/">Datenschutzerklärung</a> gelesen und akzeptiert.</p>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="twoculumform">
                                        <br>
