...
<div class="grid margtop">
  ...
  <div class="grid-full">
    ...
    <div class="fullteaser backgroundfull">
      ...
      <div>
        <h1 class="margin30">HAAKE-BECK BadeinselRegatta®  <br>Verlosung der Startplätze
 ...
 <div class="fullteaser backgroundfull">
      ...
      <div class="teaserinner">
          ...
          <form action="/aktionen/badeinselregatta/anmeldung_regatta.php" method="post" accept-charset="uft-8">
            <h2 class="yellow">Wettpaddeln auf der Haake-Beck BadeinselRegatta® 2016</h2>
              ...
              <p><strong>Haake-Beck Newsletter</strong><br><br>
                ...
                <?php  } else { ?> 
                <p class="center">Tragt eure Daten ein und ergattert mit etwas Glück einen der begehrten Startplätze.<br><br></p>
                <?php if (!empty($error)) { ?>
                <p><b>Fehler:</b><br><?= $error ?><br></p>
                <?php } ?>

                <label class="yellow floatleft marginbottom10"><b>Euer Team besteht aus:</b></label> <br><input name="team" class="floatleft radiobuttons" value="Frauen" type="radio" <?php if ($team == 'Frauen') echo 'checked'; ?>/> <label class="floatleft">Frauen</label> <br><input class="floatleft radiobuttons" name="team" value="Herren"  type="radio" <?php if ($team == 'Herren') echo 'checked'; ?>/> <label class="floatleft">Herren</label>
                <br><input class="floatleft radiobuttons" name="team" value="Mix" <?php if ($team == 'Mix') echo 'checked'; ?> type="radio" /> <label class="floatleft">Mix</label>
                <div class="clear"></div>
                <p><br><br><b>Deine Daten:</b></p>
                ...
                <div class="clear"></div>
                <p><br><br><b>Infos zu deinem Teammitglied:</b></p>
                <div class="twoculumform marginrightdoppel">


                  <input type="text" name="mg_vorname" value="<?= $mg_vorname; ?>" class="formfelder inputfelder margintop"  placeholder="Vorname*" />
                  <input type="text" name="mg_nachname"  value="<?= $mg_nachname; ?>" class="formfelder inputfelder margintop" placeholder="Nachname*" />
                  <input type="text" name="mg_email"  value="<?= $mg_email; ?>" class="formfelder inputfelder margintop" placeholder="E-Mailadresse*" />
                  <input type="text" name="mg_geburtstag" value="<?= $mg_geburtstag; ?>" class="formfelder inputfelder margintop" placeholder="Geburtsdatum* TT.MM.JJJJ" />
                  <div class="clear"></div>
                ...
                <div class="twoculumform">
                  ...
                  <input type="text" name="mg_strasse" class="formfelder inputfelder margintop" placeholder="Straße / Hausnummer" value="<?= $mg_strasse; ?>" />
                  <input type="text" name="mg_plz" value="<?= $mg_plz; ?>" class="formfelder inputfelder margintop" placeholder="Postleitzahl" />
                  <input type="text" name="mg_ort" value="<?= $mg_ort; ?>" class="formfelder inputfelder margintop" placeholder="Ort" />
                  <input type="text" name="mg_tel" value="<?= $mg_telefon; ?>" class="formfelder inputfelder margintop" placeholder="Telefon tagsüber" />
                </div>
                <div class="clear"></div>
                ...
                <div class="twoculumform">
                  ...
                  <p><br><input type="checkbox" name="tnb" class="margintop" value="1" <?php if ($tnb == '1') echo 'checked'; ?>/> Ich habe die Teilnahmebedingungen und die <a href="/datenschutz/" target="_blank">Datenschutzerklärung</a> gelesen und akzeptiert.</p>
                  <div class="clear"></div>
                </div>
      ...
      <div id="slider" class="owl-carousel">
        ...
        <div>
          <p>
            1.  Veranstalter der Haake-Beck BadeinselRegatta® 2016 ist die Anheuser-Busch InBev Deutschland GmbH & Co. KG, Am Deich 18/19, 28199 Bremen. 
            <br /><br />
      ...
      <div>
          <p>
            6. Zu gewinnen gibt es 5 Startplätze für je einen Gewinner und einen Teampartner bei der Haake-Beck BadeinselRegatta® am 23.07.2016.
            <br /><br />
