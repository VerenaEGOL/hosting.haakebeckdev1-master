...
if ($submit && !$eintrag) {
    ...
    $stmt = $pdo->prepare('SELECT * FROM 2020_02_29_Heimspiel WHERE email = :email');
    ...
    if (empty($error)) {
        $stmt = $pdo->prepare('INSERT INTO `2020_02_29_Heimspiel` (`antw`, `anrede`, `v_name`, `n_name`, `strasse`, `plz`, `ort`, `email`, `telefon`, `geburtstag`, `eintrag`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
    ...
    <div class="teaserinner">
      <div >
        <div>
          ...
          <a href="#"><img src="/images/visuals/FIN_HOME.jpg" class="visual" title="" alt="HAAKEBECK" /></a>
          <div class="trennline linelast"></div>
          <h2 class="yellow">Gewinne Karten für die Heimspiele vom SV Werder Bremen</h2>
          <form action="/aktionen/2019-Heimspiel/2020-02-29/" method="post" accept-charset="uft-8">
            <p class="center">Beantworte die folgende Frage, trage deine Daten in die dafür vorgesehenen Felder ein und mit ein bisschen Glück bist du am 29.02.2020 beim Spiel Werder Bremen vs. Eintracht Frankfurt dabei!</p>
            <?php if($eintrag ==1) { ?>
            <br />
      ...
      <div id="slider" class="owl-carousel">
        <div class="produebersicht">
          <p>1.Veranstalter des Gewinnspiels ist die Anheuser-Busch InBev Deutschland GmbH & Co. KG, Am Deich 18/19, 28199 Bremen. 
            ...
            4. Das Gewinnspiel startet am 06.02.2020. Teilnahmeschluss ist der 20.02.2020 um 23:59h.
            ...
            6. Zu gewinnen gibt es 2x2 Tickets für das Spiel Werder Bremen vs. Eintracht Frankfurt am 29.02.2020 inkl. 4 Getränkegutscheine pro Person. 
