...
if ($submit && !$eintrag) {
    ...
    $stmt = $pdo->prepare('SELECT * FROM 2019_11_02_Heimspiel WHERE email = :email');
    ...
    if (empty($error)) {
        $stmt = $pdo->prepare('INSERT INTO `2019_11_02_Heimspiel` (`antw`, `anrede`, `v_name`, `n_name`, `strasse`, `plz`, `ort`, `email`, `telefon`, `geburtstag`, `eintrag`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
    ...
    <div class="teaserinner">
      <div >
        <div>
          ...
          <form action="/aktionen/2019-Heimspiel/2019-11-02/" method="post" accept-charset="uft-8">
            <p class="center">Beantworte die folgende Frage, trage deine Daten in die dafür vorgesehenen Felder ein und mit ein bisschen Glück bist du am 02.11.2019 beim Spiel Werder Bremen vs. SC Freiburg dabei!</p>
            <?php if($eintrag ==1) { ?>
            <br />
      ...
      <div id="slider" class="owl-carousel">
        <div class="produebersicht">
          <p>1.Veranstalter des Gewinnspiels ist die Anheuser-Busch InBev Deutschland GmbH & Co. KG, Am Deich 18/19, 28199 Bremen. 
            ...
            4. Das Gewinnspiel startet am 10.10.2019. Teilnahmeschluss ist der 24.10.2019 um 23:59h.
            ...
            6. Zu gewinnen gibt es 2x2 Tickets für das Spiel Werder Bremen vs. SC Freiburg am 02.11.2019 inkl. 4 Getränkegutscheine pro Person. 
