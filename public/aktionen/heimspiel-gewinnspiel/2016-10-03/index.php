...
if($_POST['abschicken']) { 
  ...
  if (empty($error)) {
    $insert="INSERT INTO `2016_10_03_Heimspiel` (
    `antw` ,
    `anrede` ,
    `v_name` ,
    `n_name` ,
    ...
    <div class="teaserinner">
      <div >
        <div>
          ...
          <p class="center">Beantworte die folgende Frage, trage deine Daten in die dafür vorgesehenen Felder ein und mit ein bisschen Glück bist du am 14.-16.10.2016 beim Spiel SV Werder Bremen vs. Bayer 04 Leverkusen dabei!
          
          <br><bR><strong>Das Gewinnspiel ist beendet. Die Gewinner sind:</strong><br>Daria L. aus Vechta<br>Rainer U. aus Visselhövede</p> 
        </div>
      </div>
    </div>
  </div>
      ...
      <div id="slider" class="owl-carousel">
        <div class="produebersicht">
          <p>1.Veranstalter des Gewinnspiels ist die Anheuser-Busch InBev Deutschland GmbH & Co. KG, Am Deich 18/19, 28199 Bremen. 
            ...
            4. Das Gewinnspiel startet am 03.10.2016. Teilnahmeschluss ist der 09.10.2016 um 23:59h.
            ...
            6. Zu gewinnen gibt es 2x2 Tickets für das Spiel SV Werder Bremen vs. Bayer 04 Leverkusen am 14.-16.10.2016. 
