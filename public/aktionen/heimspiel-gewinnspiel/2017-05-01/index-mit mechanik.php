...
if($_POST['abschicken']) { 
  ...
  if (empty($error)) {
    $insert="INSERT INTO `2017_05_01_Heimspiel` (
    `antw` ,
    `anrede` ,
    `v_name` ,
    `n_name` ,
    ...
    <div class="teaserinner">
      <div >
        <div>
          ...
          <form action="/aktionen/heimspiel-gewinnspiel/2017-05-01/" method="post" accept-charset="uft-8">
            <p class="center">Beantworte die folgende Frage, trage deine Daten in die dafür vorgesehenen Felder ein und mit ein bisschen Glück bist du am 13.-15.05.2017 beim Spiel SV Werder Bremen vs. TSG 1899 Hoffenheim dabei!</p>
            <?php if($eintrag ==1) { ?>
            <br />
            ...
            <?php } ?>
            <h2 class="yellow">Wie heißt der Torwarttrainer vom SV Werder Bremen?</h2>
            ...
            <label class="floatleft">Fritz Munder</label>
            <div class="clear"></div>
      ...
      <div id="slider" class="owl-carousel">
        <div class="produebersicht">
          <p>1.Veranstalter des Gewinnspiels ist die Anheuser-Busch InBev Deutschland GmbH & Co. KG, Am Deich 18/19, 28199 Bremen. 
            ...
            4. Das Gewinnspiel startet am 01.05.2017. Teilnahmeschluss ist der 07.05.2017 um 23:59h.
            ...
            6. Zu gewinnen gibt es 2x2 Tickets für das Spiel SV Werder Bremen vs. TSG 1899 Hoffenheim am 13.-15.05.2017. 
