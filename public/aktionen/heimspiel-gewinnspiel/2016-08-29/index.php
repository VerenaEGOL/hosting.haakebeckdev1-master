...
if($_POST['abschicken']) { 
  ...
  if (empty($error)) {
    $insert="INSERT INTO `2016_08_29_Heimspiel` (
    `antw` ,
    `anrede` ,
    `v_name` ,
    `n_name` ,
      ...
      <div >
        <div>
          ...
          <h2 class="yellow">Gewinne Karten für die Heimspiele vom SV Werder Bremen</h2>
            ...
            <p class="center">Beantworte die folgende Frage, trage deine Daten in die dafür vorgesehenen Felder ein und mit ein bisschen Glück bist du am 11.09.2016 beim Spiel SV Werder Bremen vs. FC Augsburg dabei!<br><bR><strong> Das Gewinnspiel ist beendet. Die Gewinner sind:</strong><br>Anne	L. aus Bremen<br>
Arwed	P. aus Bremerhaven
</p>
      ...
      <div id="slider" class="owl-carousel">
        <div class="produebersicht">
          <p>1.Veranstalter des Gewinnspiels ist die Anheuser-Busch InBev Deutschland GmbH & Co. KG, Am Deich 18/19, 28199 Bremen. 
            ...
            4. Das Gewinnspiel startet am 29.08.2016. Teilnahmeschluss ist der 04.09.2016 um 23:59h.
            ...
            6. Zu gewinnen gibt es 2x2 Tickets für das Spiel SV Werder Bremen vs. FC Augsburg am 11.09.2016. 
