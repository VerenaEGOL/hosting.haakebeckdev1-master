...
if($_POST['abschicken']) { 
  ...
  if (empty($error)) {
    $insert="INSERT INTO `2017_02_20_Heimspiel` (
    `antw` ,
    `anrede` ,
    `v_name` ,
    `n_name` ,
      ...
      <div >
        <div>
          ...
          <h2 class="yellow">Gewinne Karten für die Heimspiele vom SV Werder Bremen</h2>
            ...
            <p class="center">Beantworte die folgende Frage, trage deine Daten in die dafür vorgesehenen Felder ein und mit ein bisschen Glück bist du am 03.-05.03.2017 beim Spiel SV Werder Bremen vs. Darmstadt 98 dabei!<br><br><strong>Das Gewinnspiel ist beendent. Die Gewinner sind: </strong><br>Karina N. aus Hodenhagen<br>
Siebo A. aus Wittmund</p>
          ...
          <?php /*?>  <?php if($eintrag ==1) { ?>
            ...
            <?php } ?>
            <h2 class="yellow">Wie heißt das ECHTE Gespräch präsentiert vom SV Werder Bremen und Haake-Beck?</h2>
            <label class="marginbottom floatleft">Anwort*:</label>
            <input name="antw" class="floatleft radiobuttons" value="1"  type="radio" />
            <label class="floatleft">Werder up´n Swutsch</label>
            <input class="floatleft radiobuttons" name="antw" value="2"  type="radio" />
            <label class="floatleft">Es war einmal</label>
            <div class="clear"></div>
  ...
  <?php /*?> <?php if($eintrag != 1) { ?><div class="fullteaser backgroundfull">
    <div class="teaser_HAAKEBECK"><img src="/images/design/HAAKEBECK.png" title="" alt="HAAKEBECK" /></div>
      ...
      <div id="slider" class="owl-carousel">
        <div class="produebersicht">
          <p>1.Veranstalter des Gewinnspiels ist die Anheuser-Busch InBev Deutschland GmbH & Co. KG, Am Deich 18/19, 28199 Bremen. 
            ...
            4. Das Gewinnspiel startet am 20.02.2017. Teilnahmeschluss ist der 26.02.2017 um 23:59h.
            ...
            6. Zu gewinnen gibt es 2x2 Tickets für das Spiel SV Werder Bremen vs. Darmstadt 98 am 03.-05.03.2017. 
