...
if($_POST['abschicken']) { 
  ...
  if (empty($error)) {
    $insert="INSERT INTO `2017_03_20_Heimspiel` (
    `antw` ,
    `anrede` ,
    `v_name` ,
    `n_name` ,
      ...
      <div >
        <div>
          ...
          <h2 class="yellow">Gewinne Karten für die Heimspiele vom SV Werder Bremen</h2>
            ...
            <p class="center">Beantworte die folgende Frage, trage deine Daten in die dafür vorgesehenen Felder ein und mit ein bisschen Glück bist du am 04.-06.04.2017 beim Spiel SV Werder Bremen vs. Schalke 04 dabei!<br><br><strong>Das Gewinnspiel ist beendet. Gewonnen haben:</strong><br>
            Renate van O. aus Remels<br>
Katharina G. aus Delmenhorst</p>
