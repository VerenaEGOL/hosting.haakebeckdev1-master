...
<html lang="de">
  <head>
    <?php $pagetitle='Maibock'; require_once("../../include/head.php"); ?>
  ...
  <body class="maintheme">
    ...
    <div class="grid margtop">
      ...
      <div class="grid-full">
        ...
        <div class="fullteaser backgroundfull">
          ...
          <div class="teaserinner">
            ...
            <h1 class="margin30">Maibock<bR>Würziger und starker Saisongenuss</h1>
            <div class="trennline linefirst"></div>
            <a href="#"><img src="/images/visuals/haake-beck-maibock.jpg" class="visual" title="" alt="HAAKEBECK Maibock" /></a>
            <div class="trennline linelast"></div>
            <h2 class="yellow">Der Frühlingsbote von Haake-Beck</h2>
            <p class="center">Würzig und stark – Haake-Beck Maibock ist unser Frühlingsbote, den Sie jedes Jahr von Mitte Februar bis Anfang Mai genießen können. Nach alter Tradition gebraut, hat dieses würzige Starkbier einen Alkoholgehalt von 7,2 % Vol. und 62 kcal/ pro 100g Bier</p>
      ...
      <div class="grid-c2 coilteaser backgroundcoil firstcoil">
          ...
          <div class="teaser_content produkte">
            ...
            <div id="slider" class="owl-carousel">
              <div>
                <img src="/images/produkte/haake-beck-maibock-gebinde-33-flasche.png" title="" alt="Haake-Beck Maibock 0,33l Flasche" class="produktbild" />
                <p class="produktsubtitle center">0,33l Flasche</p>
              </div>
              
              <div>
                <img src="/images/produkte/haake-beck-maibock-gebinde-6x33-traeger.png" title="" alt="Haake-Beck Maibock 24 x 0,33l Kasten" class="produktbild" />
        ...
        <div class="grid-c2 coilteaser backgroundcoil secondcoil">
          ...
          <div class="teaser_content">
            <h3>Haake-Beck Maibock</h3><br><table class="produkte_naehrwerte">
              <tr>
      ...
      <div class="grid-c4">  <?php $product = 'Maibock'; require_once("../../include/sidebar.php"); ?>
      </div>
